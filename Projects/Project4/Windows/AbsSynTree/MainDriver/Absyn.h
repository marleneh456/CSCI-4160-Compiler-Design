...
namespace absyn
{
	...
	class TreeNode;			//Ancestor of all nodes
	class Program_class;	//Represent a COOL program
	class Class_class;		//Represent a class in COOL program
	class Feature_class;	//Represent a feature in a COOL class, parent of Method and Attr classes
	class Method;			//Represent a method of a COOL class
	class Attr;				//Represent an attribute of a COOL class

	class Formal_class;			//Represent a parameter of a method definition
	class Expression_class;		//Represent an expression. It is the parent of all expression classes
	class Branch_Class;			//Represent a branch of a Case expression
	class AssignExp;			//Represent an assignment statement
	class StaticCallExp;		//Represent a method call like: dog@Animal.bark()
	class CallExp;				//Represent a method call like: dog.walk()
	class IfExp;				//Represent a if-then-else expression
	class WhileExp;				//Represent a while loop
	class CaseExp;				//Represent a case expression
	class BlockExp;				//Represent a list of expressions
	class LetExp;				//Represent a let expression
	class OpExp;				//Represent an arithmetic expression involving one binary operator
	class NotExp;				//Represent logical NOT expression

	class IntExp;				//Represent an Integer constant
	class BoolExp;				//Represent an Boolean constant
	class StringExp;			//Represent an String constant

	class NewExp;				//Represent a new expression to generate an object from a class
	class IsvoidExp;			//Represent a call to isvoid operator
	class ObjectExp;			//Represent a variable, which refers to an object
